...
(* OASIS_START *)
(* DO NOT EDIT (digest: 7bf82eefb954af9f246a963291ba0a42) *)
(*
...
let setup_t =
  {
            ...
            [
               Executable
                 ({
                   ...
                   {exec_custom = false; exec_main_is = "demilekarantuite.ml"
                   })
            ];
     ...
     oasis_version = "0.4.4";
     oasis_digest =
       Some "\138\243\245\184\147\146\129\185\167\179\255\240k\216\164\138";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false
  };;
